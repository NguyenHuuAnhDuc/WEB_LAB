<div id="id05" class="modal">
	<form class="modal-content animate" action="./resetpass_process.php" method="post">
	...
	<div class="container">
        ...
        <p>
            ...
            <input required type="password" placeholder="Enter Old Password" id="oldPass" name="oldPass" 
            title="Must contain at least 8 characters, an uppercase, an lowercase and a number" >
        </p>
        <p>
            <label for="psw"><b>New Password</b>
              <span class="w3-right" id='informNew'></span>
            </label>
            <input required type="password" autocomplete="off" placeholder="Enter New Password" id="psw" name="psw" 
            title="Must contain at least 8 characters, an uppercase, an lowercase and a number" onkeyup='checkOld();'>
        </p>
        <p>
            <label for="psw"><b>Confirm new password</b>
              <span class="w3-right" id='inform'></span>
            </label>
            <input required id="confirm" autocomplete="off" type="password" name="confirm_password" 
