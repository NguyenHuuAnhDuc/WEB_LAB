<div id="id02" class="modal">
	<form class="modal-content animate" action="./signup_processing.php" method="post">
    ...
    ?>
        ...
        <span id="uname" class="w3-right"></span>
			...
			<input onkeyup='uname();' type="text" placeholder="Enter username" id="username" name="username" 
      title="Username only contain letters, numbers and underscore" required>
		</p>
		<p>
			<label for="e-mail"><b>Email</b>
        <span id="mail" class="w3-right"></span>
      </label>
			<input onkeyup='ver();' type="text" placeholder="Enter email" id="email" name="email" 
    ...
    <p>
      <label for="psw"><b>Confirm password</b>
      ...
      <input required id="confirm" type="password" name="confirm_password" placeholder="Confirm Password" onkeyup='check();'>
		...
		<input class="lo" type="submit" name="submit1" value="Sign up">
		<label>
